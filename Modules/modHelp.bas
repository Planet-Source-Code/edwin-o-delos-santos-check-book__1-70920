...
Public Function HHShowContents(lhWnd As Long)
    HTMLHelp lhWnd, App.Path & "\checkbook.chm" & ">Main", HH_DISPLAY_TOC, 0
End Function

'----------SHOW HTMLHELP INDEX----------'
Public Function HHShowIndex(lhWnd As Long)
    HTMLHelp lhWnd, App.Path & "\checkbook.chm" & ">Main", HH_DISPLAY_INDEX, 0
End Function

'----------SHOW HTMLHELP TOPIC----------'
Public Function HHShowTopic(lhWnd As Long, lngTopicID As Long)
    HTMLHelp lhWnd, App.Path & "\checkbook.chm" & ">Main", HH_HELP_CONTEXT, lngTopicID
End Function
